...
public class VersionInfo {
    ...
    public VersionInfo(byte[] bytes) throws IOException {
        ...
        // An NTAG21x or Ultralight EV1 tag will return just 8 bytes of version data
        if (bytes.length > 8) {
    ...
    public String getHardwareStorageSize8Bytes() {
      return String.format("%s%d", ((hardwareStorageSize & 1) > 0 ? ">" : "="), (int) Math.pow (2, hardwareStorageSize >> 1));
    }
    ...
    public String productTypeLookup(int productType) {
        ...
        if (upperNibble == 0) {
            ...
            upperNippleType = "Implementation";
        } else if (upperNibble == 9) {
            upperNippleType = "Applet on a Java card";
        } else if (upperNibble == 10) {
            upperNippleType = "MIFARE 2GO";
        } else {
    ...
    public String dump() {
        ...
        sb.append("Identification: ").append(productTypeLookup(hardwareType)).append("\n");
        ...
        sb.append("batchNumber: ").append(Utils.bytesToHexNpe(batchNumber)).append("\n");
        ...
        sb.append("Storage size: ").append(getHardwareStorageSize()).append(" bytes").append("\n");
        sb.append("*** dump ended ***").append("\n");
        return sb.toString();
    }

    public String dump8Bytes() {
        StringBuilder sb = new StringBuilder();
        sb.append("Version data dump (8 bytes)").append("\n");
        sb.append("fixedHeader: ").append(fixedHeader).append("\n");
        sb.append("hardwareVendorId: ").append(hardwareVendorId).append("\n");
        sb.append("hardwareType: ").append(hardwareType).append("\n");
        sb.append("hardwareSubtype: ").append(hardwareSubtype).append("\n");
        sb.append("Identification: ").append(productTypeLookup(hardwareType)).append("\n");
        ...
        sb.append("hardwareStorageSize: ").append(hardwareStorageSize).append("\n");
        sb.append("hardwareProtocol: ").append(hardwareProtocol).append("\n");
        sb.append("Free User Storage size: ").append(getHardwareStorageSize8Bytes()).append(" bytes").append("\n");
        sb.append("*** dump ended ***").append("\n");
        return sb.toString();
    }
